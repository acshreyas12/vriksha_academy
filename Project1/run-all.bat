...
start "Vriksha Academy - Backend (Spring Boot)" cmd /k "cd /d %~dp0backend && mvn spring-boot:run"

echo [2/2] Starting React Frontend on http://localhost:5173 ...
start "Vriksha Academy - Frontend (Vite)" cmd /k "cd /d %~dp0frontend && npm run dev"
